function fx = calcBrakesForce(velocity, parameters)
% CALCBRAKESFORCE       Calculates braking force as a function of velocity by linearly interpolating a thrust force lookup table
% Inputs:
...
%% Magnetic braking
% Force determined from lookup table linking velocity and braking force
