function pl = calcPl(slip,vt,pl_lookup_table,parameters)
% CALCPL            Calculates power loss as a function of slip and velocity by bilinearly interpolating a power loss lookup table
% Inputs:
%   slip            Absolute slip
