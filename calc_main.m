function [v,a,distance,theta,omega,torque,torque_lat,torque_motor,power,power_loss,power_input,efficiency,frequency,f_thrust,f_lat_wheel,f_x_pod,f_y_pod] = calc_main(phase,i,dt,n_wheel,n_brake,v,a,distance,theta,omega,torque,torque_lat,torque_motor,power,power_loss,power_input,efficiency,frequency,f_thrust,f_lat_wheel,f_x_pod,f_y_pod,lim_parameters,braking_force,fx_lookup_table,pl_lookup_table,of_coefficients)
...
% phase = 3 -- Max RPM
% @author      Andreas Malekos, Rafael Anderka, Lorenzo Principe
